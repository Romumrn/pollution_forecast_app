...
directory_path = "C:/Users/Administrateur/Documents/talend/data/csv"

# Name of the table to load data into
table_name = "data_from_csv"

# List of column names for the table (adjust these to match your table's structure)
column_names = ["Date de début","Date de fin","Organisme","code zas","Zas","code site","nom site","type d'implantation","Polluant","type d'influence","discriminant","Réglementaire","type d'évaluation","procédure de mesure","type de valeur","valeur","valeur brute","unité de mesure","taux de saisie","couverture temporelle","couverture de données","code qualité","validité"
]
